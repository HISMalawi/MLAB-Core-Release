...
import { e as endpoints, f as fetchRequest, _ as _imports_0 } from './fetch-63049419.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div class="py-5"><h3 class="text-xl font-semibold flex items-center"><img${ssrRenderAttr("src", _imports_0)} class="w-8 h-8 mr-2"> MoH Diagonistic Reports (Parasitology) </h3></div><div class="w-full flex justify-between py-5"><div class="flex items-center space-x-3">`);
...
//# sourceMappingURL=parasitology-7144ad2f.mjs.map
