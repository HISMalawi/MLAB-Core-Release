...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-caf77828>`);
  _push(ssrRenderComponent(_component_datatable, {
    ...
    header: withCtx((header, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<p class="uppercase" data-v-caf77828${_scopeId}>${ssrInterpolate(header.text)}</p>`);
      } else {
        return [
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-caf77828"]]);

export { __nuxt_component_2 as _ };
//# sourceMappingURL=Datatable-d607d390.mjs.map
