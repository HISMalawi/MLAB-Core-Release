...
import { useSSRContext, defineComponent, ref, resolveComponent, unref, withCtx, createVNode, createTextVNode, isRef, toDisplayString, mergeProps } from 'vue';
...
import { a as render$4, e as endpoints, f as fetchRequest, r as render$5 } from './fetch-39024911.mjs';
...
import { _ as __nuxt_component_1$2 } from './SearchBar-a0fe3266.mjs';
import { _ as __nuxt_component_2 } from './Datatable-d607d390.mjs';
import { _ as _imports_0$1 } from './blood_drop-69df3a8f.mjs';
import { a as render$1$1, r as render$8 } from './PencilSquareIcon-77446728.mjs';
import { r as render } from './TrashIcon-b1416ff8.mjs';
<<<<<<<< HEAD:server/chunks/app/_nuxt/specimen-types-852148a3.mjs
...
>>>>>>>> 6676e6c582c458131c78193d4457be94894744ff:server/chunks/app/_nuxt/specimen-types-c5ef916d.mjs
...
const _sfc_main$4 = {
  ...
  methods: {
    async submitForm() {
      ...
      if (data.value) {
        this.handleClick();
        useNuxtApp().$toast.success(`${this.name} specimen type created successfully!`);
        this.loading = false;
        this.name = "";
        this.description = "";
                        ...
                        if (_push5) {
                          ...
                          _push5(ssrRenderComponent(_component_DialogTitle, {
                            ...
                            default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                              if (_push6) {
                                _push6(` Create Specimen `);
                              } else {
                                return [
                                  createTextVNode(" Create Specimen ")
                                ];
                              }
                            }),
                            _: 1
...
_sfc_main$4.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/specimen-types/add-dialog/index.vue");
                      ...
                      default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          ...
                          _push5(ssrRenderComponent(_component_DialogTitle, {
                            ...
                            default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                              if (_push6) {
                                _push6(`<img${ssrRenderAttr("src", _imports_0$1)} class="w-8 h-8 mr-2"${_scopeId5}> View Specimen `);
                              } else {
                                return [
                                  createVNode("img", {
                                    src: _imports_0$1,
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/specimen-types/view-dialog/index.vue");
...
const _sfc_main$2 = {
  ...
  methods: {
    async submitForm() {
      this.loading = true;
      const request = {
        route: `${endpoints.specimens}/${this.data.id}`,
        method: "PUT",
        token: `${this.cookie}`,
        body: this.data
      };
                      ...
                      default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          ...
                          _push5(ssrRenderComponent(_component_DialogTitle, {
                            ...
                            default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                              if (_push6) {
                                _push6(` Edit Specimen `);
                              } else {
                                return [
                                  createTextVNode(" Edit Specimen ")
                                ];
                              }
                            }),
                            _: 1
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/specimen-types/edit-dialog/index.vue");
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    async function submitForm(id) {
      ...
      if (data.value) {
        handleClick();
        useNuxtApp().$toast.success(`Specimen type deleted successfully!`);
        loading.value = false;
        $emit("update", true);
      }
      if (error.value) {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(ssrRenderComponent(_component_FormKit, {
                                type: "form",
                                "submit-label": "Update",
                                onSubmit: ($event) => submitForm(__props.data.id),
                                actions: false
                              }, {
                                default: withCtx(({ value }, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<div class="mt-2 space-y-3 px-5"${_scopeId5}><div class="rounded px-2 py-2"${_scopeId5}> Do you really want to delete <span class="font-semibold text-red-500"${_scopeId5}>${ssrInterpolate(__props.data.name)}</span>? Note that once this action is completed, it can not be undone </div>`);
                                    _push6(ssrRenderComponent(_component_FormKit, {
                                      type: "textarea",
                                      label: "Reason",
                                      validation: "required",
                                    ...
                                    return [
                                      createVNode("div", { class: "mt-2 space-y-3 px-5" }, [
                                        createVNode("div", { class: "rounded px-2 py-2" }, [
                                          ...
                                          createVNode("span", { class: "font-semibold text-red-500" }, toDisplayString(__props.data.name), 1),
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/specimen-types/delete-dialog/index.vue");
...
const _sfc_main = {
  ...
  components: { MagnifyingGlassIcon: render$2 },
  data() {
    return {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_SpecimenTypesAddDialog = __nuxt_component_1;
  const _component_CoreSearchBar = __nuxt_component_1$2;
  const _component_CoreDatatable = __nuxt_component_2;
  const _component_SpecimenTypesViewDialog = __nuxt_component_4;
  const _component_SpecimenTypesEditDialog = __nuxt_component_5;
  const _component_SpecimenTypesDeleteDialog = _sfc_main$1;
  ...
  _push(`<div class="flex items-center justify-between py-5"><div class="text-2xl font-semibold flex items-center uppercase"><img${ssrRenderAttr("src", _imports_0)} alt="report-icon" class="w-8 h-8 mr-2"> ${ssrInterpolate($data.header)}</div><div class="flex items-center space-x-3">`);
  _push(ssrRenderComponent(_component_SpecimenTypesAddDialog, { onUpdate: $options.updateSpecimenTypes }, null, _parent));
  ...
  _push(ssrRenderComponent(_component_CoreDatatable, {
    ...
    actions: withCtx(({ item }, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_SpecimenTypesViewDialog, { data: item }, null, _parent2, _scopeId));
        _push2(ssrRenderComponent(_component_SpecimenTypesEditDialog, {
          data: item,
          onUpdate: $options.updateSpecimenTypes
        }, null, _parent2, _scopeId));
        _push2(ssrRenderComponent(_component_SpecimenTypesDeleteDialog, {
          data: item,
          onUpdate: $options.updateSpecimenTypes
        }, null, _parent2, _scopeId));
        _push2(`</div>`);
        ...
        return [
          createVNode("div", { class: "py-2 flex items-center space-x-2" }, [
            createVNode(_component_SpecimenTypesViewDialog, { data: item }, null, 8, ["data"]),
            createVNode(_component_SpecimenTypesEditDialog, {
              data: item,
              onUpdate: $options.updateSpecimenTypes
            }, null, 8, ["data", "onUpdate"]),
            createVNode(_component_SpecimenTypesDeleteDialog, {
              data: item,
              onUpdate: $options.updateSpecimenTypes
            }, null, 8, ["data", "onUpdate"])
          ])
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/test-catalog/specimen-types.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const specimenTypes = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { specimenTypes as default };
<<<<<<<< HEAD:server/chunks/app/_nuxt/specimen-types-852148a3.mjs
//# sourceMappingURL=specimen-types-852148a3.mjs.map
========
//# sourceMappingURL=specimen-types-c5ef916d.mjs.map
>>>>>>>> 6676e6c582c458131c78193d4457be94894744ff:server/chunks/app/_nuxt/specimen-types-c5ef916d.mjs
