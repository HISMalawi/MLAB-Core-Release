...
import { r as render$2, a as render$4$1 } from './fetch-63157596.mjs';
...
import { _ as _imports_0 } from './spreadsheets-b72be089.mjs';
...
<<<<<<<< HEAD:server/chunks/app/_nuxt/metrics-29b12c7a.mjs
import './nuxt-link-149f0ed2.mjs';
import 'ufo';
========
import './nuxt-link-42c558b2.mjs';
>>>>>>>> db8a3962de902d8d9f97ce555bb6c63b1094610b:server/chunks/app/_nuxt/metrics-ef4be6e9.mjs
...
const _sfc_main$4 = {
  ...
  methods: {
    async submitForm() {
      ...
      const { data, error, pending } = await stockModule.createStockUnit(`${this.cookie}`, params);
                        ...
                        if (_push5) {
                          ...
                          _push5(ssrRenderComponent(_component_DialogTitle, {
                            ...
                            default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                              if (_push6) {
                                _push6(` Create Stock Metric `);
                              } else {
                                return [
                                  createTextVNode(" Create Stock Metric ")
                                ];
                              }
                            }),
                            _: 1
...
_sfc_main$4.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/stock/metrics/add-dialog/index.vue");
                      ...
                      default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          ...
                          _push5(ssrRenderComponent(_component_DialogTitle, {
                            ...
                            default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                              if (_push6) {
                                _push6(`<img${ssrRenderAttr("src", _imports_0)} class="w-8 h-8 mr-2"${_scopeId5}> View Stock Metric `);
                              } else {
                                return [
                                  createVNode("img", {
                                    src: _imports_0,
                                  ...
                                  createTextVNode(" View Stock Metric ")
                                ];
                              }
                            }),
                            _: 1
                          ...
                          _push5(`<button${_scopeId4}>`);
                          _push5(ssrRenderComponent(_component_XMarkIcon, { class: "w-5 h-5" }, null, _parent5, _scopeId4));
                          _push5(`</button></div><div class="space-y-3 px-5 py-5"${_scopeId4}><div class="w-full flex flex-col space-y-1"${_scopeId4}><label class="font-semibold text-lg"${_scopeId4}>Name</label><p${_scopeId4}>${ssrInterpolate($props.data.name)}</p></div></div>`);
                        } else {
                          return [
                            createVNode("div", { class: "border-b px-3 py-3 flex items-center justify-between" }, [
                              createVNode(_component_DialogTitle, {
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/stock/metrics/view-dialog/index.vue");
...
const _sfc_main$2 = {
  ...
  methods: {
    ...
    async submitForm() {
      ...
      const { data, error, pending } = await stockModule.updateStockUnit(`${this.cookie}`, params);
      this.loading = pending;
      if (data.value) {
        this.handleClick();
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/stock/metrics/edit-dialog/index.vue");
...
const _sfc_main$1 = {
  ...
  methods: {
    ...
    async voidStockSupplier(id) {
      this.loading = true;
      const stockModule = new StockModule$1();
      const { data, error, pending } = await stockModule.voidStockUnit(`${this.cookie}`, { "reason": this.reason, id });
      this.loading = pending;
      if (data.value) {
        this.handleClick();
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/stock/metrics/delete-dialog/index.vue");
...
const _sfc_main = {
  ...
  methods: {
    async init() {
      this.loading = true;
      const stockModule = new StockModule$1();
      const { data, pending, error } = await stockModule.getStockUnit(`${this.cookie}`);
      this.loading = pending;
      if (data.value) {
        this.metrics = data.value.map((metric) => ({
          ...metric,
          created_date: moment(metric.created_date).format(dateFormat)
        }));
        this.loading = false;
      }
      if (error.value) {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_StockMetricsAddDialog = __nuxt_component_1;
  const _component_CoreSearchBar = __nuxt_component_1$1;
  const _component_CoreDatatable = __nuxt_component_2;
  const _component_StockMetricsViewDialog = __nuxt_component_4;
  const _component_StockMetricsEditDialog = __nuxt_component_5;
  const _component_StockMetricsDeleteDialog = __nuxt_component_6;
  ...
  _push(ssrRenderComponent(_component_StockMetricsAddDialog, { onUpdate: $options.init }, null, _parent));
  _push(`</div><div class="flex items-center justify-end py-5">`);
  ...
  _push(ssrRenderComponent(_component_CoreDatatable, {
    ...
    actions: withCtx(({ item }, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_StockMetricsViewDialog, {
          data: item,
          onUpdate: $options.init
        }, null, _parent2, _scopeId));
        _push2(ssrRenderComponent(_component_StockMetricsEditDialog, {
          data: item,
          onUpdate: $options.init
        }, null, _parent2, _scopeId));
        _push2(ssrRenderComponent(_component_StockMetricsDeleteDialog, {
          data: item,
          onUpdate: $options.init
        }, null, _parent2, _scopeId));
        _push2(`</div>`);
        ...
        return [
          createVNode("div", { class: "py-2 flex items-center space-x-2" }, [
            createVNode(_component_StockMetricsViewDialog, {
              data: item,
              onUpdate: $options.init
            }, null, 8, ["data", "onUpdate"]),
            createVNode(_component_StockMetricsEditDialog, {
              data: item,
              onUpdate: $options.init
            }, null, 8, ["data", "onUpdate"]),
            createVNode(_component_StockMetricsDeleteDialog, {
              data: item,
              onUpdate: $options.init
            }, null, 8, ["data", "onUpdate"])
          ])
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/stock-management/metrics.vue");
...
<<<<<<<< HEAD:server/chunks/app/_nuxt/metrics-29b12c7a.mjs
//# sourceMappingURL=metrics-29b12c7a.mjs.map
========
//# sourceMappingURL=metrics-ef4be6e9.mjs.map
>>>>>>>> db8a3962de902d8d9f97ce555bb6c63b1094610b:server/chunks/app/_nuxt/metrics-ef4be6e9.mjs
