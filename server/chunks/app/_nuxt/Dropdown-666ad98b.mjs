...
import { openBlock, createElementBlock, createElementVNode, resolveComponent, mergeProps, withCtx, createVNode, toDisplayString, createBlock, createCommentVNode, withDirectives, vModelText, Fragment, renderList, Transition, useSSRContext } from 'vue';
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_ListboxOptions, {
          class: "absolute mt-1 w-full max-h-96 overflow-auto rounded-md bg-white py-1 text-base ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm drop-shadow-md divide-y divide-gray-100",
          style: { "z-index": "10000" }
        }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              if ($props.isSearchable) {
                _push3(`<div class="relative"${_scopeId2}><div class="absolute inset-y-0 left-0 flex items-center p-3 pointer-events-none"${_scopeId2}>`);
                _push3(ssrRenderComponent(_component_MagnifyingGlassIcon, { class: "w-5 h-5" }, null, _parent3, _scopeId2));
                _push3(`</div><input${ssrRenderAttr("value", $data.search)} type="text" placeholder="Search..." class="w-full pl-10 px-4 py-2 focus:ring-none focus:outline-none"${_scopeId2}></div>`);
              } else {
                _push3(`<!---->`);
              }
              _push3(`<!--[-->`);
...
//# sourceMappingURL=Dropdown-666ad98b.mjs.map
