...
<<<<<<<< HEAD:server/chunks/app/_nuxt/blood-bank-6b940b66.mjs
...
>>>>>>>> db8a3962de902d8d9f97ce555bb6c63b1094610b:server/chunks/app/_nuxt/blood-bank-235e6ced.mjs
...
const _sfc_main = {
  setup() {
    useHead({
      title: `${Package.name.toUpperCase()} - Blood Bank Report`
    });
  },
  data() {
    return {
  ...
  methods: {
    async getReportIndicators() {
      const request = {
        route: `${endpoints.reportIndicators}?department=blood bank`,
        method: "GET",
        token: `${this.cookie}`
      };
    ...
    async getReportData() {
      if (this.yearSelected.name == "select year") {
        ...
        this.viewing = true;
        const request = {
          route: `${endpoints.mohReport}blood_bank?year=${this.yearSelected.name}`,
          method: "GET",
          token: `${this.cookie}`
        };
        const { data, error, pending } = await fetchRequest(request);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div class="py-5"><div class="text-2xl font-semibold flex items-center uppercase"><img${ssrRenderAttr("src", _imports_2)} alt="report-icon" class="w-8 h-8 mr-2"> Blood Bank Report </div></div><div class="w-full flex justify-between py-5"><div class="flex items-center space-x-3"><div class="bg-gray-100 pl-2.5 rounded flex items-center text-zinc-500">`);
  ...
  _push(ssrRenderComponent(_component_excel, {
    ...
    header: [`BLOOD BANK MoH LABORATORY REPORT ${$data.yearSelected.name}`, $data.facility.details.name, $data.facility.details.address, $data.facility.details.phone],
    data: $data.reportData,
    worksheet: "report-work-sheet",
    name: `moh_blood_bank_report_${$data.yearSelected.name}.xls`
  }, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/reports/moh/blood-bank.vue");
...
<<<<<<<< HEAD:server/chunks/app/_nuxt/blood-bank-6b940b66.mjs
//# sourceMappingURL=blood-bank-6b940b66.mjs.map
========
//# sourceMappingURL=blood-bank-235e6ced.mjs.map
>>>>>>>> db8a3962de902d8d9f97ce555bb6c63b1094610b:server/chunks/app/_nuxt/blood-bank-235e6ced.mjs
