...
import { e as endpoints, f as fetchRequest, h as calculateAge } from './fetch-1797e116.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_ExportToExcel, {
    ...
    filename: `daily_${$data.reportType.value}_${$data.moment(/* @__PURE__ */ new Date()).format("yyy_MM_DD")}`
  }, {
...
//# sourceMappingURL=daily-log-1a4da4f0.mjs.map
