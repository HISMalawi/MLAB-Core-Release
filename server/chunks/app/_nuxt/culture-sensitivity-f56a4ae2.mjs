...
const LazyCultureSensitivityGeneralCounts = defineAsyncComponent(() => import('./general-counts-9d95a5a8.mjs').then((r) => r.default));
const LazyCultureSensitivityOrganismsCounts = defineAsyncComponent(() => import('./organisms-counts-65bce045.mjs').then((r) => r.default));
const LazyCultureSensitivityOrganismsWardsCounts = defineAsyncComponent(() => import('./organisms-wards-counts-0ea297f0.mjs').then((r) => r.default));
const LazyCultureSensitivityWardsCounts = defineAsyncComponent(() => import('./wards-counts-1c0d9a42.mjs').then((r) => r.default));
const LazyCultureSensitivityAst = defineAsyncComponent(() => import('./ast-12302edf.mjs').then((r) => r.default));
...
//# sourceMappingURL=culture-sensitivity-f56a4ae2.mjs.map
