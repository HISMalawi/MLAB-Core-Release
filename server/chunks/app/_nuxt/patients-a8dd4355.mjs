...
import { _ as __nuxt_component_0$1 } from './Breadcrumb-058f5536.mjs';
...
import { a as dateRange, c as constants, s as sex, e as errorMessage } from './constants-353d90a1.mjs';
...
import { h as calculateAge, r as render$3, e as endpoints, f as fetchRequest, i as capitalize, g as getParameterizedUrl } from './fetch-a6c33994.mjs';
...
const _imports_0 = "" + buildAssetsURL("nausea.bd1778ec.svg");
                            ...
                            if (_push5) {
                              ...
                              _push5(ssrRenderComponent(unref(DialogTitle), {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<img${ssrRenderAttr("src", _imports_0)} class="w-8 h-8 mr-2"${_scopeId5}> Create patient `);
                                  } else {
                                    return [
                                      createVNode("img", {
                                        src: _imports_0,
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(ssrRenderComponent(unref(DialogTitle), {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<img${ssrRenderAttr("src", _imports_0)} class="w-8 h-8 mr-2"${_scopeId5}> ${ssrInterpolate("Find or Create patient")}`);
                                  } else {
                                    return [
                                      createVNode("img", {
                                        src: _imports_0,
                      ...
                      default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          ...
                          _push5(ssrRenderComponent(_component_DialogTitle, {
                            ...
                            default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                              if (_push6) {
                                _push6(`<img${ssrRenderAttr("src", _imports_0)} class="w-8 h-8 mr-2"${_scopeId5}> View patient `);
                              } else {
                                return [
                                  createVNode("img", {
                                    src: _imports_0,
                      ...
                      default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          ...
                          _push5(ssrRenderComponent(_component_DialogTitle, {
                            ...
                            default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                              if (_push6) {
                                _push6(`<img${ssrRenderAttr("src", _imports_0)} class="w-8 h-8 mr-2"${_scopeId5}> Edit patient `);
                              } else {
                                return [
                                  createVNode("img", {
                                    src: _imports_0,
...
const _sfc_main = {
  ...
  methods: {
    ...
    async init() {
      ...
      this.defaultData = { firstName: "", lastName: "", middleName: "", gender: "" };
      this.loading = true;
  ...
  computed: {
    ...
    filteredPatients() {
      return this.patients.map((patient) => ({
        ...patient,
        name: capitalize(`${patient.first_name} ${patient.middle_name != null ? patient.middle_name : ""} ${patient.last_name}`),
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div class="flex items-center justify-between py-5"><h3 class="text-2xl font-semibold">Patients List</h3></div><div class="flex justify-between items-center w-full px-2 py-2 mb-2"><div class="flex items-center space-x-2">`);
  _push(ssrRenderComponent(_component_CoreActionButton, {
    color: "warning",
...
//# sourceMappingURL=patients-a8dd4355.mjs.map
