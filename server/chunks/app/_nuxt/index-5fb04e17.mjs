...
import { useSSRContext, resolveComponent, mergeProps, withCtx, createVNode, withDirectives, openBlock, createBlock, createCommentVNode, Fragment, renderList, vShow, createElementBlock, createElementVNode, createTextVNode, unref, toDisplayString } from 'vue';
...
import { _ as __nuxt_component_2$1 } from './Datatable-d607d390.mjs';
...
<<<<<<<< HEAD:server/chunks/app/_nuxt/index-4865ded1.mjs
...
>>>>>>>> 6676e6c582c458131c78193d4457be94894744ff:server/chunks/app/_nuxt/index-5fb04e17.mjs
...
import { r as render$9 } from './FunnelIcon-9d1b5e2d.mjs';
import { r as render$a } from './SquaresPlusIcon-10de7253.mjs';
import { r as render$b } from './AdjustmentsVerticalIcon-b0fd4e9f.mjs';
import { r as render$c } from './CheckBadgeIcon-bee4a252.mjs';
import { a as render$d, r as render$1$1 } from './ChevronRightIcon-400fbc51.mjs';
import { r as render$e } from './ArchiveBoxXMarkIcon-1426f444.mjs';
...
const _sfc_main$3 = {
  ...
  methods: {
    async init() {
      this.handleClick();
      const selectedDepartment = this.authStore.department;
      const foundDepartment = this.authStore.user.departments.find(
        (department) => department.name === selectedDepartment
      );
      if (foundDepartment) {
        this.departmentId = foundDepartment.id;
      }
      this.selectedDepartment = selectedDepartment;
      this.departments = this.authStore.user.departments;
      await this.getTestTypes(this.departmentId);
    },
    async getTestTypes(departmentId) {
      const request = {
        route: `${endpoints.specimenTestTypes}?department_id=${departmentId}&specimen_id=${this.item.specimen_id}`,
        method: "GET",
        token: `${this.cookie}`
      };
    ...
    async submitForm() {
      this.loading = true;
      let tests = this.testTypesSelected.map((testType) => ({
  ...
  watch: {
    selectedDepartment(newDepartment, oldDepartment) {
      if (newDepartment !== oldDepartment) {
        ...
        if (foundDepartment) {
          this.departmentId = foundDepartment.id;
          this.getTestTypes(this.departmentId);
        }
      }
    }
  }
                        ...
                        if (_push5) {
                          ...
                          _push5(ssrRenderComponent(_component_FormKit, {
                            ...
                            default: withCtx(({ value }, _push6, _parent6, _scopeId5) => {
                              if (_push6) {
                                _push6(`<div class="mt-2 space-y-3 pb-40"${_scopeId5}><div class="w-full flex flex-col space-y-2 px-5"${_scopeId5}><label class="font-medium"${_scopeId5}>Department</label>`);
                                ...
                                _push6(`</div><div class="w-full flex flex-col space-y-2 px-5"${_scopeId5}><label class="font-medium"${_scopeId5}>Tests</label>`);
                                _push6(ssrRenderComponent(_component_multi_select, {
                                  style: { "--ms-max-height": "none !important" },
                                ...
                                return [
                                  createVNode("div", { class: "mt-2 space-y-3 pb-40" }, [
                                    createVNode("div", { class: "w-full flex flex-col space-y-2 px-5" }, [
                                      createVNode("label", { class: "font-medium" }, "Department"),
  ...
  methods: {
    ...
    async printBBResults() {
      ...
      if (data.value) {
        ...
        useNuxtApp().$toast.success("Results printed successfully!");
      }
      if (error.value) {
        this.zebraPrinting = false;
        useNuxtApp().$toast.error(errorMessage);
...
const _imports_0$2 = "" + buildAssetsURL("prescription_document.18f957e1.svg");
                      ...
                      default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          ...
                          _push5(ssrRenderComponent(_component_DialogTitle, {
                            ...
                            default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                              if (_push6) {
                                _push6(`<img${ssrRenderAttr("src", _imports_0$2)} class="w-8 h-8 mr-2"${_scopeId5}> View Test `);
                              } else {
                                return [
                                  createVNode("img", {
                                    src: _imports_0$2,
                          ...
                          _push5(`</div><div class="grid grid-cols-3 gap-4 px-5 py-5"${_scopeId4}><div class="rounded border"${_scopeId4}><div class="px-2 py-2 bg-gray-50 border-b rounded-t"${_scopeId4}><h3 class="text-lg font-semibold text-black flex items-center"${_scopeId4}><img${ssrRenderAttr("src", _imports_1)} class="w-7 h-7 mr-1"${_scopeId4}> Patient </h3></div><div class="w-full space-y-2 py-2"${_scopeId4}><div class="w-full flex justify-between px-4 py-1"${_scopeId4}><h3 class="font-semibold"${_scopeId4}>Patient Number</h3><p${_scopeId4}>${ssrInterpolate($data.details.client.id)}</p></div><div class="w-full flex justify-between px-4 py-2 bg-gray-50 border-b border-t border-dotted"${_scopeId4}><h3 class="font-semibold"${_scopeId4}>Name</h3><p${_scopeId4}>${ssrInterpolate(("capitalize" in _ctx ? _ctx.capitalize : unref(capitalize))(
                            `${$data.details.client.first_name} ${$data.details.client.middle_name !== null ? $data.details.client.middle_name : ""} ${$data.details.client.last_name}`
                          ...
                          _push5(`<!--]-->`);
                          if ($data.details.test_type_name == "Cross-match" && $data.details.status.toLowerCase() == "verified") {
                            _push5(`<div class="px-2.5 py-2.5 border-t"${_scopeId4}>`);
                            _push5(ssrRenderComponent(_component_CoreActionButton, {
                              loading: $data.zebraPrinting,
                              click: () => {
                                $options.printBBResults();
                              },
                              text: "Print results",
                              color: "primary",
                              icon: $data.printerIcon
                          ...
                          return [
                            ...
                            createVNode("div", { class: "mx-5 rounded border mb-5" }, [
                              ...
                              $data.details.test_type_name == "Cross-match" && $data.details.status.toLowerCase() == "verified" ? (openBlock(), createBlock("div", {
                                key: 0,
...
const _imports_0$1 = "" + buildAssetsURL("rdt_result_no_test.6a8034c1.svg");
                      ...
                      default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          ...
                          _push5(ssrRenderComponent(_component_DialogTitle, {
                            ...
                            default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                              if (_push6) {
                                _push6(`<img${ssrRenderAttr("src", _imports_0$1)} class="w-8 h-8 mr-2"${_scopeId5}> ${ssrInterpolate($props.text.charAt(0).toUpperCase() + $props.text.slice(1))} Reason `);
                              } else {
                                return [
                                  createVNode("img", {
                                    src: _imports_0$1,
  ...
  methods: {
      ...
      if (data.value) {
        this.data = data.value.data.map((test) => {
          ...
          return {
            ...
            created_date: moment(test.created_date).utcOffset(2).format(dateFormat)
          };
        });
    ...
    checkStatus(status, item) {
      if (status.status === "completed") {
        if (item.test_type_name.toLowerCase().includes("culture")) {
          this.redirect(
            item,
            `/tests/result/culture-sensitivity?accession_number=${item.accession_number}&test_id=${item.id}`
          );
        } else {
          this.redirect(
            item,
            `/tests/result?accession_number=${item.accession_number}&test_id=${item.id}`
          );
        }
      } else {
        if (status.status !== "") {
    ...
    updateOnStatus(value) {
      if (value.name !== "select status") {
        const foundStatusFilter = this.filters.find(
    ...
    removeFilter(value) {
      ...
      const index2 = this.filters.findIndex(
    ...
    hideRejectActions(status) {
      return !["voided", "test-rejected", "verified"].includes(
        status.toLowerCase()
      );
    }
  },
...
const _imports_0 = "" + buildAssetsURL("experiment-results.d7dc2871.png");
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div class="flex items-center space-x-2 py-5"><img${ssrRenderAttr("src", _imports_0)} alt="experiment-results-icon" class="w-auto h-8"><h3 class="text-2xl font-semibold uppercase">Tests List</h3></div><div class="flex justify-between items-center w-full py-2 mb-2"><div class="flex items-center space-x-2">`);
  _push(ssrRenderComponent(_component_CoreActionButton, {
    text: "Refresh",
    color: "warning",
  ...
  _push(`</div><div class="pt-1"><div class="bg-gray-100 pl-2.5 rounded flex items-center text-zinc-500">`);
  ...
  _push(ssrRenderComponent(_component_CoreDatatable, {
    ...
    actions: withCtx(({ item }, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`<!--]-->`);
        if (item.status.toLowerCase() !== "test-rejected" && item.order_status.toLowerCase() === "specimen not collected") {
          _push2(ssrRenderComponent(_component_CoreActionButton, {
            color: "success",
            text: "Accept",
          ...
          createVNode("div", { class: "py-2 flex items-center" }, [
            createVNode("div", { class: "w-full flex items-center justify-between space-x-2" }, [
              withDirectives(createVNode("div", { class: "flex items-center space-x-2" }, [
                ...
                item.status.toLowerCase() !== "test-rejected" && item.order_status.toLowerCase() === "specimen not collected" ? (openBlock(), createBlock(_component_CoreActionButton, {
                  key: 1,
                  color: "success",
                  text: "Accept",
                  icon: $data.acceptIcon,
...
<<<<<<<< HEAD:server/chunks/app/_nuxt/index-4865ded1.mjs
//# sourceMappingURL=index-4865ded1.mjs.map
========
//# sourceMappingURL=index-5fb04e17.mjs.map
>>>>>>>> 6676e6c582c458131c78193d4457be94894744ff:server/chunks/app/_nuxt/index-5fb04e17.mjs
