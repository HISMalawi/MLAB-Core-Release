...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "px-5 py-5" }, _attrs))} data-v-16eaabb0>`);
      _push(ssrRenderComponent(_component_CoreBreadcrumb, { pages: unref(pages) }, null, _parent));
      _push(`<div class="flex items-center py-5" data-v-16eaabb0><img${ssrRenderAttr("src", _imports_2)} alt="report-icon" class="w-8 h-8 mr-2" data-v-16eaabb0><h3 class="text-2xl font-semibold uppercase" data-v-16eaabb0>${ssrInterpolate(unref(title))}</h3></div><div class="w-full flex items-center justify-between mb-5" data-v-16eaabb0>`);
      _push(ssrRenderComponent(_component_FormKit, {
        ...
        default: withCtx(({ value }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="w-full flex items-center space-x-3" data-v-16eaabb0${_scopeId}><div class="bg-gray-100 pl-2.5 rounded flex items-center text-zinc-500" data-v-16eaabb0${_scopeId}>`);
            _push2(ssrRenderComponent(unref(render$1), { class: "w-5 h-5 mr-2" }, null, _parent2, _scopeId));
            _push2(` Filter By Date Range <div class="w-72 ml-2" data-v-16eaabb0${_scopeId}>`);
            ...
            _push2(`</div></div><div class="bg-gray-100 pl-2.5 rounded flex items-center text-zinc-500" data-v-16eaabb0${_scopeId}>`);
            _push2(ssrRenderComponent(unref(render), { class: "w-5 h-5 mr-2 my-2.5" }, null, _parent2, _scopeId));
            _push2(` Report Type <div class="w-48 ml-2" data-v-16eaabb0${_scopeId}>`);
            ...
            _push2(`</div></div><div class="flex justify-end py-2" data-v-16eaabb0${_scopeId}><div class="bg-gray-100 rounded flex items-center text-zinc-500" data-v-16eaabb0${_scopeId}><div class="w-48" data-v-16eaabb0${_scopeId}>`);
            _push2(ssrRenderComponent(_component_CoreDropdown, {
            ...
            if (unref(selectedUser).name != null && unref(selectedUser).name !== "Select and search for user...") {
              _push2(`<button type="button" data-v-16eaabb0${_scopeId}>`);
              _push2(ssrRenderComponent(unref(render$2), { class: "w-5 h-5 mx-2 my-2.5" }, null, _parent2, _scopeId));
              _push2(`</button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div class="w-48" data-v-16eaabb0${_scopeId}>`);
      ...
      if (unref(statistics).length > 0) {
        _push(`<div id="print-container" data-v-16eaabb0>`);
        _push(ssrRenderComponent(_component_CoreDatatable, {
          ...
          actions: withCtx(({ item }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<td data-v-16eaabb0${_scopeId}>${ssrInterpolate(unref(reportTypeSelected).name.toLowerCase() == "patients registry" ? `${item.first_name}
      ...
      if (unref(statistics).length == 0 && !unref(loading)) {
        _push(`<div class="w-full flex flex-col items-center justify-center space-y-2 py-10" data-v-16eaabb0><img${ssrRenderAttr("src", _imports_1)} alt="page-icon" class="object-cover w-20 h-20" data-v-16eaabb0><p data-v-16eaabb0>Data not found, please generate report</p></div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(loading) && unref(statistics).length == 0) {
        _push(`<div class="mx-auto justify-center flex flex-col items-center space-y-3" data-v-16eaabb0>`);
        _push(ssrRenderComponent(_component_CoreLoader, null, null, _parent));
        _push(`<p class="text-base" data-v-16eaabb0>Generating report, please wait<span class="animate-ping" data-v-16eaabb0>...</span></p></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const userStatistics = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-16eaabb0"]]);

export { userStatistics as default };
//# sourceMappingURL=user-statistics-2cdab334.mjs.map
