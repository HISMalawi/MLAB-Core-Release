...
import { u as useAuthStore, l as render$3$1, e as endpoints, f as fetchRequest, s as showTestDetails, h as capitalize, d as calculateAge, S as StatusList, i as render$1$2, m as render$5$1, n as render$2$1, r as render$k, P as PrinterService } from './fetch-bdf4b52b.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div class="flex items-center justify-between py-5"><h3 class="text-2xl font-semibold">Tests List</h3></div><div class="flex justify-between items-center w-full py-2 mb-2"><div class="flex items-center space-x-2">`);
  _push(ssrRenderComponent(_component_CoreActionButton, {
    text: "Refresh",
    color: "warning",
...
//# sourceMappingURL=index-f66e4f0c.mjs.map
