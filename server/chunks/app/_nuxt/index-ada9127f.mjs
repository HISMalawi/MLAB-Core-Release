...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div class="mt-5"><div class="flex items-center space-x-2"><img${ssrRenderAttr("src", _imports_0)} class="w-auto h-6" alt="flash-icon"><h3 class="text-xl font-semibold uppercase"> New order for <span>`);
  _push(ssrRenderComponent(_component_nuxt_link, {
    class: "text-sky-500 text-xl font-semibold",
    to: `/patients?search=${$options.patientName.toLowerCase().replace(" ", "+")}`
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(` \u201C${ssrInterpolate($options.patientName)}\u201D `);
      } else {
        return [
          createTextVNode(" \u201C" + toDisplayString($options.patientName) + "\u201D ", 1)
        ];
      }
    }),
    _: 1
  }, _parent));
  _push(`</span></h3></div><div class="border rounded mt-5"><div class="bg-gray-50 flex items-center space-x-3 px-2 py-2 rounded-tr rounded-tl border-b"><img${ssrRenderAttr("src", _imports_1)} class="h-8 w-auto" alt="fever-icon"><h3 class="font-semibold text-lg">Patient Details</h3></div><div class="w-full py-5 px-5"><div class="flex items-center space-x-20"><div class="flex items-center space-x-3"><h3 class="font-medium">Patient Number:</h3><p class="mt-1 text-gray-600">${ssrInterpolate($options.patientNumber)}</p></div><div class="flex items-center space-x-3"><h3 class="font-medium">Age</h3><p class="mt-1 text-gray-600">${ssrInterpolate($options.patientAge)} years old</p></div><div class="flex items-center space-x-3"><h3 class="font-medium">Sex:</h3><p class="mt-1 text-gray-600">${ssrInterpolate($options.patientSex)}</p></div></div></div></div>`);
  _push(ssrRenderComponent(_component_FormKit, {
    ...
    default: withCtx(({ value }, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="border mt-5 rounded"${_scopeId}><div class="bg-gray-50 flex items-center space-x-3 px-2 py-2 rounded-tr rounded-tl border-b"${_scopeId}><h3 class="font-semibold text-lg"${_scopeId}>Order Details</h3></div><div class="px-5 py-5"${_scopeId}><div class="w-full mb-5"${_scopeId}><div class="flex flex-col space-y-2"${_scopeId}>`);
        ...
        _push2(ssrRenderComponent(_component_CoreDropdown, {
          ...
          class: $data.visitTypeSelected.name == "select visit type" && "text-gray-600"
        }, null, _parent2, _scopeId));
        ...
        _push2(ssrRenderComponent(_component_CoreDropdown, {
          ...
          class: $data.wardSelected.name == "select ward" && "text-gray-600"
        }, null, _parent2, _scopeId));
        ...
        _push2(ssrRenderComponent(_component_CoreDropdown, {
          ...
          class: $data.specimenSelected.name == "select specimen" && "text-gray-600"
        }, null, _parent2, _scopeId));
        ...
        if ($data.isBDE) {
          _push2(`<div class="w-full mb-5 flex flex-col space-y-2"${_scopeId}><label class="font-medium"${_scopeId}>Sample collection date</label>`);
          _push2(ssrRenderComponent(_component_datepicker, {
            ...
            modelValue: $data.sampleCollectionDate,
        ...
        return [
          createVNode("div", { class: "border mt-5 rounded" }, [
            createVNode("div", { class: "bg-gray-50 flex items-center space-x-3 px-2 py-2 rounded-tr rounded-tl border-b" }, [
              createVNode("h3", { class: "font-semibold text-lg" }, "Order Details")
            ]),
...
<<<<<<<< HEAD:server/chunks/app/_nuxt/index-69aeb696.mjs
//# sourceMappingURL=index-69aeb696.mjs.map
========
//# sourceMappingURL=index-ada9127f.mjs.map
>>>>>>>> db8a3962de902d8d9f97ce555bb6c63b1094610b:server/chunks/app/_nuxt/index-ada9127f.mjs
