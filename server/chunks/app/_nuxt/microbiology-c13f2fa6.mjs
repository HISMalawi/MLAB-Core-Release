...
<<<<<<<< HEAD:server/chunks/app/_nuxt/microbiology-7e049d14.mjs
...
>>>>>>>> 6676e6c582c458131c78193d4457be94894744ff:server/chunks/app/_nuxt/microbiology-c13f2fa6.mjs
...
const _sfc_main = {
  setup() {
    useHead({
      title: `${Package.name.toUpperCase()} - Microbiology Report`
    });
  },
  data() {
    return {
  ...
  methods: {
    async getReportIndicators() {
      const request = {
        route: `${endpoints.reportIndicators}?department=Microbiology`,
        method: "GET",
        token: `${this.cookie}`
      };
    ...
    async getReportData() {
      if (this.yearSelected.name == "select year") {
        ...
        this.viewing = true;
        const request = {
          route: `${endpoints.mohReport}microbiology?year=${this.yearSelected.name}`,
          method: "GET",
          token: `${this.cookie}`
        };
        const { data, error, pending } = await fetchRequest(request);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div class="py-5"><div class="text-2xl font-semibold flex items-center uppercase"><img${ssrRenderAttr("src", _imports_2)} alt="report-icon" class="w-8 h-8 mr-2"> Microbiology Report </div></div><div class="w-full flex justify-between py-5"><div class="flex items-center space-x-3"><div class="bg-gray-100 pl-2.5 rounded flex items-center text-zinc-500">`);
  ...
  _push(ssrRenderComponent(_component_excel, {
    ...
    header: [`MICROBIOLOGY MoH LABORATORY REPORT ${$data.yearSelected.name}`, $data.facility.details.name, $data.facility.details.address, $data.facility.details.phone],
    data: $data.reportData,
    worksheet: "report-work-sheet",
    name: `moh_microbiology_report_${$data.yearSelected.name}.xls`
  }, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/reports/moh/microbiology.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const microbiology = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { microbiology as default };
<<<<<<<< HEAD:server/chunks/app/_nuxt/microbiology-7e049d14.mjs
//# sourceMappingURL=microbiology-7e049d14.mjs.map
========
//# sourceMappingURL=microbiology-c13f2fa6.mjs.map
>>>>>>>> 6676e6c582c458131c78193d4457be94894744ff:server/chunks/app/_nuxt/microbiology-c13f2fa6.mjs
