...
const LazyCultureSensitivityGeneralCounts = defineAsyncComponent(() => import('./general-counts-e0201276.mjs').then((r) => r.default));
const LazyCultureSensitivityOrganismsCounts = defineAsyncComponent(() => import('./organisms-counts-3c5c9fb0.mjs').then((r) => r.default));
const LazyCultureSensitivityOrganismsWardsCounts = defineAsyncComponent(() => import('./organisms-wards-counts-b7bf84ef.mjs').then((r) => r.default));
const LazyCultureSensitivityWardsCounts = defineAsyncComponent(() => import('./wards-counts-59cd121b.mjs').then((r) => r.default));
const LazyCultureSensitivityAst = defineAsyncComponent(() => import('./ast-f7ddb381.mjs').then((r) => r.default));
...
//# sourceMappingURL=culture-sensitivity-6f4f749c.mjs.map
