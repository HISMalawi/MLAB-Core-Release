...
<<<<<<<< HEAD:server/chunks/app/_nuxt/biochemistry-c4d4ee96.mjs
...
>>>>>>>> 6676e6c582c458131c78193d4457be94894744ff:server/chunks/app/_nuxt/biochemistry-a10c788c.mjs
...
const _sfc_main = {
  ...
  methods: {
    async getReportIndicators() {
      const request = {
        route: `${endpoints.reportIndicators}?department=Biochemistry`,
        method: "GET",
        token: `${this.cookie}`
      };
    ...
    async getReportData() {
      if (this.yearSelected.name == "select year") {
        ...
        this.viewing = true;
        const request = {
          route: `${endpoints.mohReport}biochemistry?year=${this.yearSelected.name}`,
          method: "GET",
          token: `${this.cookie}`
        };
        const { data, error, pending } = await fetchRequest(request);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div class="py-5"><div class="text-2xl font-semibold flex items-center uppercase"><img${ssrRenderAttr("src", _imports_2)} alt="report-icon" class="w-8 h-8 mr-2"> Biochemistry Report </div></div><div class="w-full flex justify-between py-5"><div class="flex items-center space-x-3"><div class="bg-gray-100 pl-2.5 rounded flex items-center text-zinc-500">`);
  ...
  _push(ssrRenderComponent(_component_excel, {
    ...
    header: [`BIOCHEMISTRY MoH LABORATORY REPORT ${$data.yearSelected.name}`, $data.facility.details.name, $data.facility.details.address, $data.facility.details.phone],
    data: $data.reportData,
    worksheet: "report-work-sheet",
    name: `moh_biochemistry_report_${$data.yearSelected.name}.xls`
  }, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/reports/moh/biochemistry.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const biochemistry = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { biochemistry as default };
<<<<<<<< HEAD:server/chunks/app/_nuxt/biochemistry-c4d4ee96.mjs
//# sourceMappingURL=biochemistry-c4d4ee96.mjs.map
========
//# sourceMappingURL=biochemistry-a10c788c.mjs.map
>>>>>>>> 6676e6c582c458131c78193d4457be94894744ff:server/chunks/app/_nuxt/biochemistry-a10c788c.mjs
