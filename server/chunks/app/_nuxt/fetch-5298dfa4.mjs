...
import { a as useNuxtApp, e as defineStore, p as persistedState, u as useCookie, h as useRequestFetch, b as __nuxt_component_0, _ as _export_sfc, c as createError } from '../server.mjs';
...
import { b as sessionExpiryMessage, e as errorMessage, r as render$9, l as loginErrorMessage, d as dateFormat } from './constants-9b77e6ea.mjs';
...
const expiresAt = () => {
  ...
  expirationDate.setDate(expirationDate.getDate() + 365 * 5);
...
async function fetchRequest(request) {
  let bodyObject = null;
  const { ip: ip2, port: port2 } = useNetworkStore();
  const baseUrl = `http://${ip2}:${port2}/api/v1/`;
...
export { Api as A, HttpFactory as H, PrinterService as P, StatusList as S, render$4 as a, useNetworkStore as b, filterArrays as c, calculateAge as d, endpoints as e, fetchRequest as f, getParameterizedUrl as g, capitalize as h, render$1 as i, useFetch as j, reverseFilterArrays as k, render$3 as l, render$5 as m, render$2 as n, useAlert as o, isEmpty as p, useRouteStore as q, render as r, showTestDetails as s, useAuthStore as u };
//# sourceMappingURL=fetch-5298dfa4.mjs.map
