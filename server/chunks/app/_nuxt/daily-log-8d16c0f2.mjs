...
import { _ as _sfc_main$5 } from './Address-af315606.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(ExportToExcel), {
        ...
        filename: `daily_${unref(reportType).value}_${unref(moment)( new Date()).format("yyy_MM_DD")}`
      }, {
...
//# sourceMappingURL=daily-log-8d16c0f2.mjs.map
