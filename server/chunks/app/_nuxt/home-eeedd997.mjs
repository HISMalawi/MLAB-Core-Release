...
import { useSSRContext, defineComponent, ref, mergeProps, reactive, openBlock, createElementBlock, createElementVNode, resolveComponent, withCtx, createVNode, createTextVNode, toDisplayString, createBlock, createCommentVNode, Transition, unref } from 'vue';
...
import { u as useAuthStore, e as endpoints, f as fetchRequest } from './fetch-647b8df7.mjs';
...
import { _ as _imports_0$8 } from './admissions-269aee20.mjs';
...
function _sfc_ssrRender$9(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "border rounded col-span-1" }, _attrs))}><div style="${ssrRenderStyle(!$data.loading ? null : { display: "none" })}"><div class="flex rounded-t items-center justify-between bg-gray-50 px-2 py-2 border-b text-xl font-semibold"><h3>${ssrInterpolate(_ctx.$t("Tests"))}</h3>`);
              ...
              _push3(ssrRenderComponent(_component_MenuItem, null, {
                default: withCtx(({ active }, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    ...
                    _push4(` ${ssrInterpolate(_ctx.$t("Filter_by_date"))}</button>`);
                  } else {
                    return [
                      createVNode("button", {
                        onClick: ($event) => {
                        ...
                        createTextVNode(" " + toDisplayString(_ctx.$t("Filter_by_date")), 1)
                      ], 10, ["onClick"])
                    ];
                  }
                }),
              ...
              _push3(ssrRenderComponent(_component_MenuItem, null, {
                default: withCtx(({ active }, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    ...
                    _push4(` ${ssrInterpolate($data.viewChart ? _ctx.$t("View_summary") : _ctx.$t("View_as_Pie_Chart"))}</button>`);
                  } else {
                    return [
                      createVNode("button", {
                        ...
                        createTextVNode(" " + toDisplayString($data.viewChart ? _ctx.$t("View_summary") : _ctx.$t("View_as_Pie_Chart")), 1)
                      ], 10, ["onClick"])
                    ];
                  }
                }),
  ...
  _push(`<div style="${ssrRenderStyle(!$data.viewChart && !$data.showFilters ? null : { display: "none" })}"><div class="flex items-center space-x-2 px-5 py-2"><img${ssrRenderAttr("src", _imports_0$1)}><h3 class="text-3xl font-semibold">${ssrInterpolate($data.testsData.tests_count.data.toLocaleString())}</h3></div><div class="w-full px-5 py-2 space-y-2"><div class="flex items-center justify-between"><h3 class="font-medium">${ssrInterpolate(_ctx.$t("Pending"))}</h3><p>${ssrInterpolate($data.testsData.statuses_count["pending"])}</p></div><div class="flex items-center justify-between"><h3 class="font-medium">${ssrInterpolate(_ctx.$t("Verified"))}</h3><p>${ssrInterpolate($data.testsData.statuses_count["verified"])}</p></div><div class="flex items-center justify-between"><h3 class="font-medium">${ssrInterpolate(_ctx.$t("Rejected"))}</h3><p>${ssrInterpolate($data.testsData.statuses_count["test-rejected"])}</p></div></div></div></div>`);
...
const _imports_1 = "" + buildAssetsURL("hospital.1f9f843c.svg");
...
function _sfc_ssrRender$8(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if (!$data.loading) {
    ...
    _push(`</span></p></div><div class="flex items-center space-x-5"><div class="px-2 py-2 bg-gray-100 rounded"><img${ssrRenderAttr("src", _imports_1)} class="w-8 h-8"></div><p class="text-3xl font-bold">${ssrInterpolate((_b = $data.analyticsData) == null ? void 0 : _b.facilities)}<span class="text-sm font-medium hover:text-sky-500 hover:underline ml-2">`);
...
//# sourceMappingURL=home-eeedd997.mjs.map
