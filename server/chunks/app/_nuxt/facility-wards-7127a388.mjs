...
<<<<<<<< HEAD:server/chunks/app/_nuxt/facility-wards-2a2bc1e2.mjs
...
>>>>>>>> 6676e6c582c458131c78193d4457be94894744ff:server/chunks/app/_nuxt/facility-wards-7127a388.mjs
...
const _sfc_main$4 = {
  ...
  methods: {
    /**
     * @method submitForm creates a new ward entry
     * @param null
    ...
    async submitForm() {
      ...
      if (data.value) {
        this.handleClick();
        useNuxtApp().$toast.success(`${this.name} ward created successfully!`);
        this.name = "";
        this.loading = false;
...
_sfc_main$4.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/wards/add-dialog/index.vue");
  return _sfc_setup$4 ? _sfc_setup$4(props, ctx) : void 0;
};
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$4]]);
const _imports_0 = "" + buildAssetsURL("home_alt.25ad17d0.svg");
const _sfc_main$3 = {
  components: {
    TransitionRoot,
    TransitionChild,
                      ...
                      default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          ...
                          _push5(ssrRenderComponent(_component_DialogTitle, {
                            ...
                            default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                              if (_push6) {
                                _push6(`<img${ssrRenderAttr("src", _imports_0)} class="w-8 h-8 mr-2"${_scopeId5}> View ward `);
                              } else {
                                return [
                                  createVNode("img", {
                                    src: _imports_0,
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/wards/view-dialog/index.vue");
...
const _sfc_main$2 = {
  ...
  methods: {
    /**
     * @method submitForm updates ward
     * @param null
     * @returns promise @type void
     */
    async submitForm() {
      this.loading = true;
      let request = {
        route: `${endpoints.sections}/${this.data.id}`,
        method: "PUT",
        token: `${this.cookie}`,
        body: this.data
      };
      ...
      if (data.value) {
        this.handleClick();
        useNuxtApp().$toast.success(`Ward updated successfully!`);
        this.loading = false;
        this.$emit("update", true);
      }
      if (error.value) {
                      ...
                      default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          ...
                          _push5(ssrRenderComponent(_component_DialogTitle, {
                            ...
                            default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                              if (_push6) {
                                _push6(`<img${ssrRenderAttr("src", _imports_0)} class="w-8 h-8 mr-2"${_scopeId5}> Edit ward `);
                              } else {
                                return [
                                  createVNode("img", {
                                    src: _imports_0,
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/wards/edit-dialog/index.vue");
...
const _sfc_main$1 = {
  ...
  methods: {
    /**
     * @method deleteData deletes ward
     * @param id ward id
    ...
    async deleteData(id) {
      ...
      if (data.value) {
        this.handleClick();
        useNuxtApp().$toast.success(`Ward deleted successfully!`);
        this.loading = false;
        this.$emit("update", true);
      }
      if (error.value) {
                          ...
                          _push5(ssrRenderComponent(_component_FormKit, {
                            ...
                            default: withCtx(({ value }, _push6, _parent6, _scopeId5) => {
                              if (_push6) {
                                ...
                                _push6(ssrRenderComponent(_component_CoreOutlinedButton, { text: "Cancel" }, null, _parent6, _scopeId5));
                                _push6(ssrRenderComponent(_component_CoreActionButton, {
                                  loading: $data.loading,
                                  type: "submit",
                                  click: () => {
                                ...
                                return [
                                  ...
                                  createVNode("div", { class: "mt-4 justify-end flex items-center space-x-3 px-3 py-2 border-t bg-gray-50" }, [
                                    createVNode(_component_CoreOutlinedButton, { text: "Cancel" }),
                                    createVNode(_component_CoreActionButton, {
                                      loading: $data.loading,
                                      type: "submit",
                                      click: () => {
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/wards/delete-dialog/index.vue");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_wards_add_dialog = __nuxt_component_1;
  const _component_CoreSearchBar = __nuxt_component_1$1;
  const _component_CoreDatatable = __nuxt_component_2;
  const _component_WardsViewDialog = __nuxt_component_4;
  const _component_WardsEditDialog = __nuxt_component_5;
  const _component_WardsDeleteDialog = __nuxt_component_6;
  ...
  _push(ssrRenderComponent(_component_wards_add_dialog, { onUpdate: $options.updateWards }, null, _parent));
  ...
  _push(ssrRenderComponent(_component_CoreDatatable, {
    ...
    onUpdate: $options.updateWards
  }, {
    actions: withCtx(({ item }, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="py-2 flex items-center space-x-2"${_scopeId}>`);
        _push2(ssrRenderComponent(_component_WardsViewDialog, { data: item }, null, _parent2, _scopeId));
        _push2(ssrRenderComponent(_component_WardsEditDialog, {
          data: item,
          onUpdate: $options.updateWards
        }, null, _parent2, _scopeId));
        _push2(ssrRenderComponent(_component_WardsDeleteDialog, {
          data: item,
          onUpdate: $options.updateWards
        }, null, _parent2, _scopeId));
        _push2(`</div>`);
        ...
        return [
          createVNode("div", { class: "py-2 flex items-center space-x-2" }, [
            createVNode(_component_WardsViewDialog, { data: item }, null, 8, ["data"]),
            createVNode(_component_WardsEditDialog, {
              data: item,
              onUpdate: $options.updateWards
            }, null, 8, ["data", "onUpdate"]),
            createVNode(_component_WardsDeleteDialog, {
              data: item,
              onUpdate: $options.updateWards
            }, null, 8, ["data", "onUpdate"])
          ])
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/lab-configuration/facility-wards.vue");
...
<<<<<<<< HEAD:server/chunks/app/_nuxt/facility-wards-2a2bc1e2.mjs
//# sourceMappingURL=facility-wards-2a2bc1e2.mjs.map
========
//# sourceMappingURL=facility-wards-7127a388.mjs.map
>>>>>>>> 6676e6c582c458131c78193d4457be94894744ff:server/chunks/app/_nuxt/facility-wards-7127a388.mjs
