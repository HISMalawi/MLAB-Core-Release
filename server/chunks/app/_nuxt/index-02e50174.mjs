...
import { a as render$4, f as fetchRequest, e as endpoints } from './fetch-39024911.mjs';
...
const _sfc_main = {
  ...
  methods: {
    ...
    async submitForm(file) {
      ...
      if (data.value) {
        data.value.printed ? useNuxtApp().$toast.success("Report printed successfully!") : useNuxtApp().$toast.warning("Could not print report!");
        this.loading = false;
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/core/printer/report/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { __nuxt_component_2 as _ };
//# sourceMappingURL=index-02e50174.mjs.map
