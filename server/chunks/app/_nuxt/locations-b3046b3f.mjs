...
<<<<<<<< HEAD:server/chunks/app/_nuxt/locations-6d078d49.mjs
...
import 'ufo';
>>>>>>>> 6676e6c582c458131c78193d4457be94894744ff:server/chunks/app/_nuxt/locations-b3046b3f.mjs
...
const _sfc_main$4 = {
  ...
  methods: {
    async submitForm() {
      ...
      const { data, error, pending } = await stockModule.createStockLocation(`${this.cookie}`, params);
      this.loading = pending;
      if (data.value) {
        this.handleClick();
        useNuxtApp().$toast.success(`${this.name} stock location created successfully!`);
        this.loading = false;
        this.description = "";
        this.name = "";
                        ...
                        if (_push5) {
                          ...
                          _push5(ssrRenderComponent(_component_DialogTitle, {
                            ...
                            default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                              if (_push6) {
                                _push6(` Create Stock Location `);
                              } else {
                                return [
                                  createTextVNode(" Create Stock Location ")
                                ];
                              }
                            }),
                            _: 1
...
_sfc_main$4.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/stock/locations/add-dialog/index.vue");
                      ...
                      default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          ...
                          _push5(ssrRenderComponent(_component_DialogTitle, {
                            ...
                            default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                              if (_push6) {
                                _push6(`<img${ssrRenderAttr("src", _imports_0)} class="w-8 h-8 mr-2"${_scopeId5}> View Stock Location `);
                              } else {
                                return [
                                  createVNode("img", {
                                    src: _imports_0,
                                  ...
                                  createTextVNode(" View Stock Location ")
                                ];
                              }
                            }),
                            _: 1
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/stock/locations/view-dialog/index.vue");
...
const _sfc_main$2 = {
  ...
  methods: {
    ...
    async submitForm() {
      ...
      const { data, error, pending } = await stockModule.updateStockLocation(`${this.cookie}`, params);
      this.loading = pending;
      if (data.value) {
        this.handleClick();
        useNuxtApp().$toast.success(`${this.name} stock location updated successfully!`);
        this.loading = false;
        this.description = "";
        this.name = "";
        this.$emit("update", true);
                      ...
                      default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          ...
                          _push5(ssrRenderComponent(_component_DialogTitle, {
                            ...
                            default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                              if (_push6) {
                                _push6(`<img${ssrRenderAttr("src", _imports_0)} class="w-8 h-8 mr-2"${_scopeId5}> Edit Stock Location `);
                              } else {
                                return [
                                  createVNode("img", {
                                    src: _imports_0,
                                  ...
                                  createTextVNode(" Edit Stock Location ")
                                ];
                              }
                            }),
                            _: 1
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/stock/locations/edit-dialog/index.vue");
...
const _sfc_main$1 = {
  ...
  methods: {
    ...
    async voidStockSupplier(id) {
      this.loading = true;
      const stockModule = new StockModule$1();
      const { data, error, pending } = await stockModule.voidStockLocation(`${this.cookie}`, { "reason": this.reason, id });
      this.loading = pending;
      if (data.value) {
        this.handleClick();
        useNuxtApp().$toast.success(`Stock location deleted successfully!`);
        this.loading = false;
        this.reason = "";
        this.$emit("update", true);
      }
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/stock/locations/delete-dialog/index.vue");
...
const _sfc_main = {
  ...
  methods: {
    async init() {
      ...
      this.loading = pending;
      if (data.value) {
        this.locations = data.value.filter((item) => ({
          ...item,
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_StockLocationsAddDialog = __nuxt_component_1;
  const _component_CoreSearchBar = __nuxt_component_1$1;
  const _component_CoreDatatable = __nuxt_component_2;
  const _component_StockLocationsViewDialog = __nuxt_component_4;
  const _component_StockLocationsEditDialog = __nuxt_component_5;
  const _component_StockLocationsDeleteDialog = __nuxt_component_6;
  ...
  _push(ssrRenderComponent(_component_StockLocationsAddDialog, { onUpdate: $options.init }, null, _parent));
  ...
  _push(ssrRenderComponent(_component_CoreDatatable, {
    ...
    actions: withCtx(({ item }, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_StockLocationsViewDialog, { data: item }, null, _parent2, _scopeId));
        _push2(ssrRenderComponent(_component_StockLocationsEditDialog, {
          data: item,
          onUpdate: $options.init
        }, null, _parent2, _scopeId));
        _push2(ssrRenderComponent(_component_StockLocationsDeleteDialog, {
          data: item,
          onUpdate: $options.init
        }, null, _parent2, _scopeId));
        _push2(`</div>`);
        ...
        return [
          createVNode("div", { class: "py-2 flex items-center space-x-2" }, [
            createVNode(_component_StockLocationsViewDialog, { data: item }, null, 8, ["data"]),
            createVNode(_component_StockLocationsEditDialog, {
              data: item,
              onUpdate: $options.init
            }, null, 8, ["data", "onUpdate"]),
            createVNode(_component_StockLocationsDeleteDialog, {
              data: item,
              onUpdate: $options.init
            }, null, 8, ["data", "onUpdate"])
          ])
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/stock-management/locations.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const locations = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { locations as default };
<<<<<<<< HEAD:server/chunks/app/_nuxt/locations-6d078d49.mjs
//# sourceMappingURL=locations-6d078d49.mjs.map
========
//# sourceMappingURL=locations-b3046b3f.mjs.map
>>>>>>>> 6676e6c582c458131c78193d4457be94894744ff:server/chunks/app/_nuxt/locations-b3046b3f.mjs
