...
<<<<<<<< HEAD:server/chunks/app/_nuxt/parasitology-754082cf.mjs
...
>>>>>>>> db8a3962de902d8d9f97ce555bb6c63b1094610b:server/chunks/app/_nuxt/parasitology-58c68b0e.mjs
...
const _sfc_main = {
  setup() {
    useHead({
      title: `${Package.name.toUpperCase()} - Parasitology Report`
    });
  },
  data() {
    return {
  ...
  methods: {
    async getReportIndicators() {
      const request = {
        route: `${endpoints.reportIndicators}?department=Parasitology`,
        method: "GET",
        token: `${this.cookie}`
      };
    ...
    async getReportData() {
      if (this.yearSelected.name == "select year") {
        ...
        this.viewing = true;
        const request = {
          route: `${endpoints.mohReport}parasitology?year=${this.yearSelected.name}`,
          method: "GET",
          token: `${this.cookie}`
        };
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div class="py-5"><h3 class="text-2xl font-semibold flex items-center uppercase"><img${ssrRenderAttr("src", _imports_2)} class="w-8 h-8 mr-2"> Parasitology Report </h3></div><div class="w-full flex justify-between py-5"><div class="flex items-center space-x-3"><div class="bg-gray-100 pl-2.5 rounded flex items-center text-zinc-500">`);
  ...
  _push(ssrRenderComponent(_component_excel, {
    ...
    header: [`PARASITOLOGY MoH LABORATORY REPORT ${$data.yearSelected.name}`, $data.facility.details.name, $data.facility.details.address, $data.facility.details.phone],
    data: $data.reportData,
    worksheet: "report-work-sheet",
    name: `moh_parasitology_report_${$data.yearSelected.name}.xls`
  }, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/reports/moh/parasitology.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const parasitology = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { parasitology as default };
<<<<<<<< HEAD:server/chunks/app/_nuxt/parasitology-754082cf.mjs
//# sourceMappingURL=parasitology-754082cf.mjs.map
========
//# sourceMappingURL=parasitology-58c68b0e.mjs.map
>>>>>>>> db8a3962de902d8d9f97ce555bb6c63b1094610b:server/chunks/app/_nuxt/parasitology-58c68b0e.mjs
